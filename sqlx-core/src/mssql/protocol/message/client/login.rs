...
impl Encode for Login7<'_> {
    ...
    fn encode(&self, buf: &mut Vec<u8>) {
        ...
        buf.put_u32::<LittleEndian>(self.version);

        // [PacketSize] The packet size being requested by the client.
        buf.put_u32::<LittleEndian>(self.packet_size);

        // [ClientProgVer] The version of the **interface** library.
        buf.put_u32::<LittleEndian>(self.client_program_version);

        // [ClientPID] The process ID of the client application.
        buf.put_u32::<LittleEndian>(self.client_pid);
